...
public class HunyDewDBExim {
	...
	public HunyDewDBExim( Context ctx, SQLiteDatabase db, String string, String inFileName )
	{
		_ctx = ctx;
		_db = db;
...
//		}
	...
	class Importer
	{
		...
		{
			this (new BufferedInputStream(_ctx.openFileInput(fileName)));	
		}
		
		public Importer(BufferedInputStream bis )
		{
			_bis = bis;
		}
